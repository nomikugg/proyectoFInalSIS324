    ...
    return (
      <Link href={`/diagnosis/${diagnosis.id}`}>
        <div className="bg-white shadow-lg dark:bg-darkElevation-400 border-primary hover:bg-slate-100 transition-all cursor-pointer p-4 rounded-md">
          <div className="font-semibold dark:text-darkSecondary">
            {diagnosis.title}
          </div>
          <div className="text-xs mt-4 dark:text-gray-400">
            {diagnosis.disease} <span> ({diagnosis.accuracy}) </span>
          </div>
      ...
      <div className="flex space-x-44">
        <div>
          ...
          <div className="mt-2">
            <DatalistInput
              ...
              listboxProps={{
                className:
                  "bg-white dark:bg-darkElevation-500 p-2 rounded-md h-[150px] overflow-y-auto ",
              }}
        ...
        <div>
          ...
          <div className="text-gray-600 text-xs">
            {diagnoses.length} Diagnoses Found
          </div>
