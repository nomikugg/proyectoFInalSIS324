  ...
  try {
    ...
    return {
      props: {
        ...
        appointedDoctors,
        doctorsFound: doctorsFound.data.doctorsFiltered,
      },
    };
  } catch (err) {
    console.log(err);
      ...
      <div>
        ...
        <div className="mt-8">
          ...
          <div className="mt-2 text-sm">
            ...
            <div>
              <span className="font-semibold">Doctors Found </span>
              {32}
            </div>
          </div>
        </div>
        ...
        <div className="mt-8">
          ...
          <div className="mt-2 text-sm">
            <div>
              ...
              {diagnosis.patient.user.fullName}
            </div>
            <div>
              <span className="font-semibold">Age : </span>32
            </div>
            <div>
              <span className="font-semibold">Medical History : </span>2 Years
            </div>
          </div>
        </div>
        <div className="mt-8">
          ...
          <div className="mt-4 space-y-5 h-[400px] overflow-y-auto">
            {doctorsFound.map(d => (
              <DoctorProfile
                ...
                doctor={d}
                role={user.role}
                patientId={user.additionalData.uuid}
              />
            ))}
          </div>
        )}
