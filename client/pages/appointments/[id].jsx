...
const MenuItem = ({ title, value, view, setView, icon }) => {
  ...
  return (
    <div
      ...
      className={`flex space-x-4  hover:text-white hover:font-semibold transition-all cursor-pointer ${
        active ? "bg-primary text-white" : "text-slate-400"
      }  text-sm items-center p-2 px-4`}
    >
      {icon}
      <div>{title}</div>
    </div>
      ...
      <div className="flex h-[93vh]">
        <div className="w-[20vw] border-r-[1px] dark:bg-darkElevation-200 bg-[#19171D] border-primary dark:border-darkElevation-900  border-opacity-30">
          ...
          <div className="mt-2 py-6 space-y-3">
            ...
            <MenuItem
              title="Schedules"
              icon={<MdOutlineScheduleSend size={20} />}
              view={view}
              setView={setView}
              value="schedules"
            />
          ...
          <div className="mt-5 px-4">
            ...
            <div className="mt-4 text-slate-200 text-xs space-y-5">
              <div className="border-b-[1px] border-slate-800 pb-3 cursor-pointer hover:scale-105 transition-all">
                ⌚ Schedule Meeting
              </div>
              <div className="border-b-[1px] border-slate-800 pb-3 cursor-pointer  hover:scale-105 transition-all">
                🏥 Send Prescription
          ...
          <div className="h-[calc(93vh-70px)]">
            ...
            {view === "schedules" && (
              <Schedules
                ...
                user={user}
                appointmentId={appointment.id}
                doctor={appointment.doctor.uuid}
              />
            )}
          </div>
        </div>
