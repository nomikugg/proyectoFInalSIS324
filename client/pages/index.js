  ...
  return (
    <div className="flex justify-between">
      <div className="p-16">
        ...
        >
          <Image
            src={!darkMode ? "/logo.svg" : "/darkLogo.svg"}
            height="40px"
            width="250px"
          />
        </div>
        <div className={`${isLogin ? "mt-28" : "mt-16"}`}>
          <div className="flex space-x-2 items-center">
            ...
            <div
              className={` ${
                error
                  ? "text-red-600 dark:text-darkError"
          ...
          <div className="mt-5 text-sm">
            ...
            <span
              className="text-primary dark:text-darkPrimary transition-all cursor-pointer font-semibold"
