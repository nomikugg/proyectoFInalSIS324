    ...
    <Modal title={"Request Appointment"} show={show} onClose={onClose}>
      <div className="text-sm">
        <Input
          ...
          placeholder="Add a request Message"
        />
        <div className="mt-10 text-xs text-gray-600">
          By Sending this request, doctor will be able to see your profile.
        </div>
        <div onClick={handleRequest} className="mt-3">
          <button className="px-2 py-1 bg-primary text-white rounded-md">
            Send Request
          </button>
        </div>
      </div>
