        ...
        <div className="flex items-center -space-x-8">
          {!options ? (
            ...
            <DatalistInput
              ...
              inputProps={{
                className:
                  "border-gray-300 dark:bg-darkElevation-200 dark:border-none dark:placeholder:text-gray-500 dark:text-white placeholder:text-gray-400 outline-none border-2 mt-1 px-2 py-[8px] rounded-sm w-full",
              }}
              onSelect={item => {
                handleAdd(item);
                setValue("");
