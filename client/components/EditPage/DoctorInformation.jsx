  ...
  return (
    <>
      <div className="text-[#5A5482] dark:text-darkPrimary font-bold text-xl flex justify-between w-full">
        ...
        <div
          onClick={handleSave}
          className="text-base dark:bg-darkPrimary dark:bg-opacity-70 bg-[#5A5482] px-4 rounded-md py-[2px] hover:scale-105 transition-all cursor-pointer text-white "
        >
          Save
        </div>
      </div>
      ...
      <div className="mt-6 space-y-4 text-black">
        <div className="flex space-x-3">
          <InputField
            ...
            value={information.details.medicalExperience}
          ...
          <InputField
            name="lisenceId"
            onChange={handleChange}
            value={information.details.lisenceId}
            label="Lisense Id"
            width="100%"
        ...
        <InputField
          name="address"
          onChange={handleChange}
          value={information.details.address}
          label={"Work Address"}
          width="100%"
        />
        <div className="flex space-x-2">
          <InputField
            name="degree"
            onChange={handleChange}
            value={information.details.degree}
            width="300px"
            label="Degree"
          />
          <InputField
            name="university"
            onChange={handleChange}
            value={information.details.university}
            width="100%"
            label="University"
          />
        </div>
