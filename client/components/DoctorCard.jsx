      ...
      <>
        {role === "patient" && (
          <button
            ...
            onClick={handleClick}
            className={cls(
              "text-[0.7rem] dark:border-none  bg-opacity-90 hover:bg-opacity-100 w-fit p-1 dark:px-2 border-[1px] text-white rounded-md px-2",
              {
                "bg-primary dark:bg-darkPrimary dark:bg-opacity-25 dark:border-none":
                  !appointmentState,
              },
              { "bg-gray-700": appointmentState === "pending" },
              {
                "bg-green-600 dark:bg-darkSecondaryVariant":
          ...
          <div className="flex justify-between w-full">
            <div>
              ...
              <div className="text-[0.7rem] text-gray-500 mt-1">
                {doctor.medicalExperience} years of Experience | {doctor.degree}{" "}
                | {doctor.university}
                {/* {doctor.uuid} */}
              </div>
