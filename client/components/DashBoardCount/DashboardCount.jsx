  ...
  return (
    <div className="bg-white dark:bg-darkElevation-200 rounded-xl p-6 w-72 h-36 cursor-pointer flex items-center justify-between hover:bg-iconBg hover:text-white group transition">
      <div>
        ...
        <div className="text-gray-600 dark:text-gray-500 text-sm tracking-wide group-hover:text-white">
          {title}
        </div>
        <div className="text-green-700 dark:text-darkPrimary text-[0.7rem] mt-1 group-hover:text-white">
          {text}
        </div>
      </div>
